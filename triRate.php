...
<div class="container">
    <table>
        ...
        foreach ($result as $row) {
            echo '<tr>';
            echo '<td>' . $row['idEval'] . '</td>';
            echo '<td>' . $row['emailEleve'] . '</td>';
            echo '<td>' . $row['idC'] . '</td>';
            echo '<td>' . $row['rate'] . '</td>';
