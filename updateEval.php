...
if(isset($_POST['modifier'])) {
    ...
    // Update course
    $evalc->updateEvalCours($idEval, $emailEleve, $idC, $rate, $comment);
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="boxed-section request-form">
                <h2 class="section-title text-center">Modify</h2>
            
        
        <form method="POST" action="" >
				<div class="field">
                <label for="idEval">ID Évaluation:</label>
				<input type="text" id="idEval" name="idEval" required>
            </div>
            <div class="field">
                <label for="emailEleve">Email de l'élève:</label>
                <input type="text" id="emailEleve" name="emailEleve" required>
            </div>
            <div class="field">
